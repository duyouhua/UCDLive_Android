...
import com.ucloud.ulive.helper.GLESHelper;

import java.nio.ByteBuffer;
import java.nio.ByteOrder;
import java.nio.FloatBuffer;

public class WhiteningGPUVideoFilter extends UVideoGPUFilter {
    ...
    public WhiteningGPUVideoFilter() {
    ...
    public void onInit(int VWidth, int VHeight) {
        ...
        glProgram = GLESHelper.createProgram(VERTEXSHADER, FRAGMENTSHADER);
